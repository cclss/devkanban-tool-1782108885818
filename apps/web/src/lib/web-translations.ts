...
export const WEB_TRANSLATIONS = {
  ko: {
    ...
    header: { wordmark: '전자계약', logoAlt: '전자계약 로고', languageSwitchLabel: '언어 선택', localeKo: '한국어', localeEn: 'English' },
  ...
  en: {
    ...
    header: { wordmark: 'eSign', logoAlt: 'eSign logo', languageSwitchLabel: 'Select language', localeKo: '한국어', localeEn: 'English' },
